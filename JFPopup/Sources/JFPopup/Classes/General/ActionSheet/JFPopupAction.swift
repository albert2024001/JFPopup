...
@objc public class JFPopupAction: NSObject {
    ...
    @objc public convenience init(with title: String?, subTitle: String?, autoDismiss: Bool = true, clickActionCallBack: @escaping (() -> Void)) {
        self.init()
        self.title = title
    ...
    @objc public convenience init(with title: String?, subAttributedTitle: NSAttributedString?, autoDismiss: Bool = true, clickActionCallBack: @escaping (() -> Void)) {
        self.init()
        self.title = title
