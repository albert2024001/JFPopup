...
public extension JFPopup where Base: UIViewController {
    ...
    func actionSheet(with autoCancelAction: Bool = true, actions: () -> [JFPopupAction]) {
        bottomSheet(with: true, enableDrag: false) {
    ...
    @discardableResult func actionSheet(with autoCancelAction: Bool = true, actions: @escaping (() -> [JFPopupAction])) -> JFPopupView? {
        return JFPopupView.popup.bottomSheet(with: true, enableDrag: false, yourView: base) { mainContainer in
            ...
            v.autoDismissHandle = { [weak mainContainer] in
                mainContainer?.dismissPopupView(completion: { _ in
...
public extension JFPopup where Base: JFPopupView {
    ...
    @discardableResult static func actionSheet(with autoCancelAction: Bool = true, yourView: UIView? = nil, actions: @escaping (() -> [JFPopupAction])) -> JFPopupView? {
        return bottomSheet(with: true, enableDrag: false, yourView: yourView) { mainContainer in
            let v = JFPopupActionSheetView(with: actions(), autoCancelAction: autoCancelAction)
            v.autoDismissHandle = { [weak mainContainer] in
                mainContainer?.dismissPopupView(completion: { _ in
...
class JFPopupActionView: UIView {
    ...
    let titleLabel: UILabel = {
        let label = UILabel()
        label.textColor = UIColor(red: 19 / 255.0, green: 20 / 255.0, blue: 19 / 255.0, alpha: 1)
    ...
    let subTitleLabel: UILabel = {
        let label = UILabel()
        label.textColor = UIColor(red: 135 / 255.0, green: 135 / 255.0, blue: 135 / 255.0, alpha: 1)
    ...
    override init(frame: CGRect) {
        ...
        addConstraints(
            [
                NSLayoutConstraint(item: verStackView, attribute: .leading, relatedBy: .equal, toItem: self, attribute: .leading, multiplier: 1, constant: 0),
                NSLayoutConstraint(item: verStackView, attribute: .trailing, relatedBy: .equal, toItem: self, attribute: .trailing, multiplier: 1, constant: 0),
                NSLayoutConstraint(item: verStackView, attribute: .centerY, relatedBy: .equal, toItem: self, attribute: .centerY, multiplier: 1, constant: 0),
            ]
        )
        addSubview(lineView)
        ...
        addConstraints(
            [
                NSLayoutConstraint(item: lineView, attribute: .leading, relatedBy: .equal, toItem: self, attribute: .leading, multiplier: 1, constant: 0),
                NSLayoutConstraint(item: lineView, attribute: .trailing, relatedBy: .equal, toItem: self, attribute: .trailing, multiplier: 1, constant: 0),
                NSLayoutConstraint(item: lineView, attribute: .bottom, relatedBy: .equal, toItem: self, attribute: .bottom, multiplier: 1, constant: 0),
                NSLayoutConstraint(item: lineView, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .height, multiplier: 1, constant: 0.5),
            ]
        )
        addSubview(clickBtn)
        clickBtn.translatesAutoresizingMaskIntoConstraints = false
        addConstraints([
            NSLayoutConstraint(item: clickBtn, attribute: .leading, relatedBy: .equal, toItem: self, attribute: .leading, multiplier: 1, constant: 0),
            NSLayoutConstraint(item: clickBtn, attribute: .trailing, relatedBy: .equal, toItem: self, attribute: .trailing, multiplier: 1, constant: 0),
            NSLayoutConstraint(item: clickBtn, attribute: .top, relatedBy: .equal, toItem: self, attribute: .top, multiplier: 1, constant: 0),
            NSLayoutConstraint(item: clickBtn, attribute: .bottom, relatedBy: .equal, toItem: self, attribute: .bottom, multiplier: 1, constant: 0),
        ])
    }
...
public class JFPopupActionSheetView: UIView {
    ...
    func configSubview() {
        backgroundColor = UIColor(red: 245 / 255.0, green: 245 / 255.0, blue: 245 / 255.0, alpha: 1)
        ...
        if var view = views.last, autoCancelAction == false {
            view.jf.height += CGFloat.jf.safeAreaBottomHeight()
            frame.size.height = view.jf.bottom
        } else {
        ...
        frame.size.width = CGSize.jf.screenWidth()
